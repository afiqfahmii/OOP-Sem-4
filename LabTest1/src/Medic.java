...
public class Medic {
 ...
 System.out.println("First doctor: "+doctorList.get(1)+ doc1.getBday());   
 System.out.println("Second doctor: "+doctorList.get(2)+doc3.getBday());     
 System.out.println("Third doctor : "+doctorList.get(0)+newDoc1.getBday());     
 System.out.println("Forth doctor "+doctorList.get(3)+newDoc2.getBday());       
